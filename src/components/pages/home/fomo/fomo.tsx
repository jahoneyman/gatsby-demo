...
const Fomo = () => {
  return (
    <section className="flex items-center justify-center bg-gray-1 py-24 text-white">
      <div className="bg-gray-3 mx-8 w-full py-8 px-3 rounded-3xl text-center md:text-start md:w-[950px] md:flex items-center justify-center">
        <div className="mx-12">
          <StaticImage
        ...
        <div>
          <Heading tag="div" className="text-primary-1 lg:mb-5">
            <h1 className="text-3xl lg:text-4xl font-bold">No more FOMO</h1>
          </Heading>
          ...
          <div>
            <TextInput
              ...
              className="w-11/12 md:w-[400px] lg:w-[450px] py-3.5 px-6 rounded-2xl font-medium"
            />
          </div>
        </div>
      </div>
